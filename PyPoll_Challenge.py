...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county > largest_county_votes) and (county_percentage > largest_county_percentage):
            largest_county_votes = county
            largest_county = county_name
            largest_county_votes_percentage = county_percentage
